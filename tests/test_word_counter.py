...
#Open rewritertools.com
#Locate Word-counter.
#Check if you have navigated to correct webpage.
#Navigate to the input box.
#Input a sample text.
#click on "count words" button.
#get the results of the word count(Total Words and Total Characters).
#Compare it with expexcted total word count and total character.
...
def test_word_counter(test_obj):
    ...
    try:
        ...
        # &
        #8 Compare it with expexcted total word count and total character.
        result_flag=test_obj.get_result(conf.sample_word_count,conf.sample_char_count)
        test_obj.log_result(result_flag,
